/*
 ...
 Source Host           : 119.91.103.60:14666
 Source Schema         : dblog
...
CREATE TABLE `biz_article`  (
  ...
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '添加时间',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `is_open` tinyint(1) NULL DEFAULT 1 COMMENT '是否公开，如果不公开则仅在管理后台，个人，超级用户及持有密钥可见',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `sys_social_config`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '社会化登录应用' ROW_FORMAT = DYNAMIC;
