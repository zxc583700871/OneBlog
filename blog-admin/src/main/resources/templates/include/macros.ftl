...
<head>
    ...
    <link href="/assets/modules/bootstrap/bootstrap-tagsinput-typeahead.min.css" rel="stylesheet">
    <link href="/assets/modules/bootstrap/bootstrap-tagsinput.min.css" rel="stylesheet">
                            ...
                            <div role="tabpanel" class="tab-pane fade active in" id="article" aria-labelledby="article-tab">
                                <div class="row">
                                    ...
                                    <div class="col col-md-9">
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12" for="comment">是否公开</label>
                                            <div class="col-md-10 col-sm-10 col-xs-12 fixed-radio-checkbox">
                                                <ul class="list-unstyled list-inline">
                                                    <li><input type="radio" class="square" name="isOpen" value="1"> 是</li>
                                                    <li><input type="radio" class="square" checked name="isOpen" value="0"> 否</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
