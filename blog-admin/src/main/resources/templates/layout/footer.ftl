...
<script type="text/javascript" src="/assets/modules/bootstrap-3.3.7/js/bootstrap.min.js"></script>
...
<script src="/assets/modules/icheck-1.0.3/icheck.min.js"></script>
...
<script src="/assets/modules/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
